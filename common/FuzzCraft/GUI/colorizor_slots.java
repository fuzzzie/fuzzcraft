...
public colorizor_slots(EntityPlayer par1EntityPlayer, IInventory par2IInventory, int par3, int par4, int par5)
{
...
protected void onCrafting(ItemStack par1ItemStack)
{
         ...
         if (!this.thePlayer.worldObj.isRemote)
         {
                 ...
                 float var3 = FuzzCraft.Handlers.Colorizor_Recipes.smelting().getExperience(par1ItemStack);
                 int var4;
