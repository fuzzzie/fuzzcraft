...
public class colorizor_tileEntity extends TileEntity implements ISidedInventory, net.minecraftforge.common.ISidedInventory
{
    ...
    {
        return this.isInvNameLocalized() ? this.field_94130_e : "Colorizor";
    }
    ...
    public void writeToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        {
            par1NBTTagCompound.setString("Colorizor", this.field_94130_e);
        }
    }
...
//                fuzzcraft.colorizorBlockA.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = FuzzCraft.Handlers.Colorizor_Recipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
