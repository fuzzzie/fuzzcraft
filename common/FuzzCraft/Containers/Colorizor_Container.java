...
public Colorizor_Container(InventoryPlayer par1InventoryPlayer, FuzzCraft.TileEntity.colorizor_tileEntity par2TileEntityFurnace)
{
...
public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
{
         ...
         if (var4 != null && var4.getHasStack())
         {
                 ...
                 {
                         if (FuzzCraft.Handlers.Colorizor_Recipes.smelting().getSmeltingResult(var5) != null)
                         {
                         ...
                         else if (FuzzCraft.TileEntity.colorizor_tileEntity.isItemFuel(var5))
                         {
