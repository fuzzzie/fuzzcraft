...
public class Colorizor_Container extends Container
{
    ...
    public Colorizor_Container(InventoryPlayer par1InventoryPlayer, colorizor_tileEntity par2TileEntityFurnace)
    {
        ...
        this.addSlotToContainer(new ColorizorSlot(par1InventoryPlayer.player, par2TileEntityFurnace, 2, 116, 35));
        int i;
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (Colorizor_Recipes.smelting().getSmeltingResult(itemstack1) != null)
                {
